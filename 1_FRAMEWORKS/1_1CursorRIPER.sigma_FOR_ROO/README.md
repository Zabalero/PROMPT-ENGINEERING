...
Current version: [ripersigma105.md](./.roo/rules/ripersigma105.mdc) - fixed* the issues with the rules not loading due to the file name having uppercase letters in their name.
